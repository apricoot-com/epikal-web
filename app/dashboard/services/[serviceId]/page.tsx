            ...
            <div className="border-b bg-background p-4 flex items-center justify-between sticky top-0 z-20">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-xl font-bold">{isNew ? "Nuevo Servicio" : name || "Editar Servicio"}</h1>
                        <p className="text-xs text-muted-foreground">{isNew ? "Crear un nuevo servicio" : "Gestionar detalles y configuración"}</p>
                    </div>
                </div>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-6">
                                        {faqs.length === 0 ? (
                                            ...
                                            faqs.map((faq, index) => (
                                                <div key={index} className="grid relative gap-4 p-4 border rounded-lg bg-muted/5 group">
