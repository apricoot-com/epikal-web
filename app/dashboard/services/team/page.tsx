            ...
            <div className="flex flex-1 flex-col p-4">
                                    ...
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            {editingId
                                                ...
                                                : "Registra un nuevo miembro del equipo que presta servicios"}
                                        </DialogDescription>
                                    </DialogHeader>
                ...
                {resources?.length === 0 ? (
                    <Card className="flex flex-col items-center justify-center py-12">
                        ...
                        <CardTitle className="mb-2">Sin profesionales</CardTitle>
                        <CardDescription className="text-center mb-4">
                            Agrega a los miembros de tu equipo para agendar sus citas
                        </CardDescription>
                        {canEdit && (
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                &quot;{resource.name}&quot; será marcado como inactivo.
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
